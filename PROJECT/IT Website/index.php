        ...
        <div class="col-lg-12">
          <div class="owl-carousel owl-banner">
            <div class="item item-1">
              <div class="header-text" style="color: darkred;">
                <span class="category">IT KNOWLAGE HUB</span>
                <h2>The Knowledge Hub is a modern, centralized knowledge management system that makes it easy to manage.</p>
                <div class="buttons">
                  <div class="main-button">
                    <a href="#">Request Demo</a>
                  </div>
                  <div class="icon-button">
                    <a href="#"><i class="fa fa-play"></i> What's IT?</a>
                  </div>
                </div>
              </div>
            </div>
